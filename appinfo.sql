...
INSERT INTO `capteur_actionneur` (`idCapteur`, `typeCapteur`, `typeActionneur`, `unite`, `Carte_idCarte`) VALUES
(1, 'sonore', '', 'Hz', 1),
(2, 'température', '', '°C', 1),
...
INSERT INTO `utilisateur` (`id`, `nom`, `prenom`, `date_naissance`, `numero_telephone`, `type`, `login`, `mot_de_passe`, `adresse_mail`) VALUES
(1, 'philippe', 'guillaume', '1999-07-25', '0619637985', 'admin', 'g.philippe', 'motdepasse', 'guillaume.philippe2000@gmail.com'),
(2, 'liu', 'lionel', '1999-01-01', '0606060606', 'admin', 'l.liu', 'lionelisep', 'l.lionel0104@gmail.com'),
(3, 'parayre', 'benjamin', '1999-01-01', '0707070707', 'admin', 'b.parayre', 'benji', 'parayre.benjamin1@gmail.com'),
(4, 'le garlantezec', 'thomas', '1999-01-01', '0607070707', 'admin', 't.garlantezec', 'legarlantezec', 'thomas.legarlantezec@gmail.com'),
(5, 'fournet', 'benjamin', '1999-01-01', '0606070707', 'admin', 'b.fournet', 'fournet99', 'benjamin.fournet99@gmail.com'),
